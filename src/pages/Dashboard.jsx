...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (token === "") {
      navigate("/login");
      toast.warn("Please login first for accessing dashboard");
    }
  ...
  return (
    <div className='dashboard-main'>
      ...
      <p className='text-center mb-8 text-gr text-6xl py-8'>{ data.msg } welcome to XYZ Solutions Pvt Ltd ! <br/><br/>{ data.luckyNumber }</p>
